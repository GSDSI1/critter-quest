...
export interface CreatureDef {
  ...
  expYield: number;
  color: number;
  shape: 'blob' | 'quadruped' | 'serpent' | 'avian' | 'humanoid' | 'crystalline' | 'insect' | 'aquatic' | 'armored';
  description: string;
  dexNumber: number;
  ability?: string;
  habitat?: string;
...
export const CREATURES: Record<string, CreatureDef> = {
  ...
  pebblite: {
    ...
    catchRate: 50, expYield: 55, color: 0x78716c, shape: 'armored',
  ...
  rockord: {
    ...
    catchRate: 30, expYield: 130, color: 0x57534e, shape: 'armored',
  ...
  coralite: {
    ...
    catchRate: 28, expYield: 135, color: 0x06b6d4, shape: 'armored',
  ...
  tidewisp: {
    ...
    catchRate: 42, expYield: 60, color: 0x38bdf8, shape: 'aquatic',
  ...
  kelpling: {
    ...
    moves: ['splash', 'tackle', 'growl'],
    catchRate: 40, expYield: 68, color: 0x14b8a6, shape: 'aquatic',
  ...
  nightmoth: {
    ...
    catchRate: 30, expYield: 140, color: 0x581c87, shape: 'insect',
  ...
  brinepup: {
    ...
    catchRate: 34, expYield: 88, color: 0x0284c7, shape: 'aquatic',
  ...
  tidemast: {
    ...
    catchRate: 20, expYield: 155, color: 0x0369a1, shape: 'aquatic',
  ...
  gleamfin: {
    ...
    catchRate: 22, expYield: 142, color: 0x38bdf8, shape: 'aquatic',
  ...
  brinecrown: {
    ...
    catchRate: 18, expYield: 168, color: 0x0284c7, shape: 'aquatic',
  ...
  buzzwing: {
    ...
    catchRate: 38, expYield: 80, color: 0xfacc15, shape: 'insect',
  ...
  sandcrab: {
    ...
    catchRate: 32, expYield: 95, color: 0xd97706, shape: 'armored',
  ...
  tidepod: {
    ...
    catchRate: 34, expYield: 82, color: 0x0ea5e9, shape: 'aquatic',
  ...
  tidewrack: {
    ...
    catchRate: 20, expYield: 142, color: 0x0284c7, shape: 'aquatic',
