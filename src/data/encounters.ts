...
export const ENCOUNTER_TABLES: Record<string, EncounterEntry[]> = {
  ...
  crystal_cave: [
    ...
    { id: 'cavemaw', minLevel: 15, maxLevel: 19, weight: 5 },
  ...
  route5: [
    ...
    { id: 'stormlet', minLevel: 26, maxLevel: 30, weight: 8 },
  ],
  route1_night: [
    ...
    { id: 'voltchick', minLevel: 3, maxLevel: 6, weight: 10 },
    { id: 'leafkit', minLevel: 3, maxLevel: 5, weight: 10 },
  ],
  route2_night: [
    { id: 'nightmoth', minLevel: 10, maxLevel: 14, weight: 22 },
    { id: 'shadeling', minLevel: 9, maxLevel: 13, weight: 18 },
    { id: 'dreamwisp', minLevel: 10, maxLevel: 14, weight: 16 },
    { id: 'bloomoss', minLevel: 10, maxLevel: 14, weight: 14 },
  ...
  route4_night: [
    ...
    { id: 'nightmoth', minLevel: 17, maxLevel: 21, weight: 18 },
    { id: 'dreamwisp', minLevel: 18, maxLevel: 22, weight: 16 },
    { id: 'frostkit', minLevel: 18, maxLevel: 22, weight: 14 },
    { id: 'snowpuff', minLevel: 17, maxLevel: 21, weight: 12 },
    { id: 'shadespecter', minLevel: 19, maxLevel: 23, weight: 10 },
    { id: 'glacetail', minLevel: 20, maxLevel: 24, weight: 6 },
  ],
  secret_grove: [
    { id: 'crystalynx', minLevel: 18, maxLevel: 24, weight: 12 },
    { id: 'thornqueen', minLevel: 16, maxLevel: 22, weight: 10 },
    { id: 'somnara', minLevel: 20, maxLevel: 26, weight: 8 },
    { id: 'dreamwisp', minLevel: 14, maxLevel: 20, weight: 16 },
    { id: 'nightmoth', minLevel: 12, maxLevel: 18, weight: 14 },
  ...
  fishing_catch: [
    ...
    { id: 'gleamfin', minLevel: 10, maxLevel: 16, weight: 22 },
  ...
  route3_night: [
    ...
    { id: 'gleamfin', minLevel: 13, maxLevel: 17, weight: 10 },
