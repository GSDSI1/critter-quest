...
export const ENCOUNTER_TABLES: Record<string, EncounterEntry[]> = {
  ...
  forest: [
    ...
    { id: 'thornbud', minLevel: 6, maxLevel: 10, weight: 12 },
    { id: 'leafkit', minLevel: 6, maxLevel: 9, weight: 12 },
  ...
  crystal_cave: [
    ...
    { id: 'crystmite', minLevel: 13, maxLevel: 17, weight: 14 },
    { id: 'rockord', minLevel: 14, maxLevel: 18, weight: 18 },
