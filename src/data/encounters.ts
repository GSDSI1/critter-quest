...
export const ENCOUNTER_TABLES: Record<string, EncounterEntry[]> = {
  ...
  route3: [
    ...
    { id: 'kelpling', minLevel: 11, maxLevel: 15, weight: 14 },
  ...
  volcanic_path: [
    { id: 'cinderkit', minLevel: 16, maxLevel: 20, weight: 16 },
    { id: 'grimlet', minLevel: 17, maxLevel: 22, weight: 18 },
    { id: 'coalemb', minLevel: 16, maxLevel: 21, weight: 14 },
    { id: 'emberlord', minLevel: 18, maxLevel: 24, weight: 8 },
    { id: 'flamewyrm', minLevel: 16, maxLevel: 20, weight: 14 },
  ...
  route5: [
    { id: 'mindling', minLevel: 26, maxLevel: 30, weight: 20 },
    { id: 'stormhorn', minLevel: 27, maxLevel: 31, weight: 14 },
    { id: 'dreamwisp', minLevel: 25, maxLevel: 29, weight: 18 },
  ...
  forest_night: [
    { id: 'shadeling', minLevel: 6, maxLevel: 10, weight: 24 },
    { id: 'shadespecter', minLevel: 8, maxLevel: 12, weight: 20 },
    { id: 'nightmoth', minLevel: 7, maxLevel: 11, weight: 16 },
  ...
  victory_road: [
    ...
    { id: 'glaciorex', minLevel: 35, maxLevel: 41, weight: 12 },
    ...
    { id: 'shadespecter', minLevel: 34, maxLevel: 40, weight: 14 },
