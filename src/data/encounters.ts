...
export const ENCOUNTER_TABLES: Record<string, EncounterEntry[]> = {
  ...
  forest: [
    { id: 'mossling', minLevel: 5, maxLevel: 8, weight: 18 },
    { id: 'shadeling', minLevel: 6, maxLevel: 10, weight: 16 },
    { id: 'murkfox', minLevel: 7, maxLevel: 11, weight: 14 },
    { id: 'leafkit', minLevel: 6, maxLevel: 9, weight: 14 },
  ...
  route4: [
    ...
    { id: 'frostnip', minLevel: 17, maxLevel: 21, weight: 16 },
    { id: 'frostmoss', minLevel: 18, maxLevel: 22, weight: 14 },
  ...
  forest_night: [
    ...
    { id: 'murkfox', minLevel: 7, maxLevel: 11, weight: 16 },
    { id: 'shadespecter', minLevel: 8, maxLevel: 12, weight: 18 },
